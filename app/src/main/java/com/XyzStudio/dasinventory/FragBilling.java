...
//*/
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        ed_biayaBil.setText(String.valueOf(this.biaya));
        ed_counterAwalBil.setText(String.valueOf(this.counterAwalBil));
//        ed_counterAkhirBil.setText(String.valueOf(this.counterAkhirBil));
        ed_totalBiayaBil.setText(String.valueOf(this.totalBiayaBil));

        /*inv = FirebaseAuth.getInstance().getCurrentUser();
        invRef = userDB.getInstance().getReference("Users");
        inv = users.getUid();*/

        btn_edHitungBil.setOnClickListener(new View.OnClickListener(){

            @Override
            public void onClick(View view) {
//                Log.d("testa", String.valueOf(ed_counterAkhirBil.getText()));
//                Log.d("testa", String.valueOf(counterAwalBil));
//                Log.d("testa", String.valueOf(biaya));
//                Log.d("testa", String.valueOf((Integer.parseInt(ed_counterAkhirBil.getText().toString())-counterAwalBil)*biaya));
                int totalBiaya = (Integer.parseInt(ed_counterAkhirBil.getText().toString())-counterAwalBil)*biaya;
                ed_totalBiayaBil.setText(String.valueOf(totalBiaya));
            }
        });
...
//
                    ...
                    database.child("Billing").child(key).setValue(new BillingData(
                            tempatBil,
                            typeBil,
                            snBil,
                            biaya,
                            Integer.parseInt(ed_counterAkhirBil.getText().toString()),
                            0,
                            Integer.parseInt(ed_totalBiayaBil.getText().toString())
